...
class Encryption:
    ...
    @staticmethod
    def sha1(passwd):
        # Used for HaveIBeenPwned service
        return SHA.new(passwd.encode("utf-8")).hexdigest().encode('ascii')
...
class Password(object):
    ...
    def sha1(self, master_password):
        return Encryption.sha1(self.cleartext(master_password))
